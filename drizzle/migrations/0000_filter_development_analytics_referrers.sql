    ...
    'referrers', COALESCE((
      ...
      FROM (
        ...
        WHERE referrer_host IS NOT NULL
          AND referrer_host <> 'lovable.dev'
          AND referrer_host NOT LIKE '%.lovable.dev'
          AND referrer_host NOT LIKE '%.lovable.app'
          AND referrer_host NOT LIKE '%.lovableproject.com'
